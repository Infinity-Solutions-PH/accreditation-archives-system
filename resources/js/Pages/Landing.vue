        ...
        <div class="max-w-[1200px] mx-auto flex flex-col gap-6">
            ...
            <div class="flex flex-wrap justify-between items-end gap-3">
                <div class="flex flex-col gap-1">
                    <h1 class="text-text-main-light dark:text-white tracking-tight text-[28px] md:text-[32px] font-bold leading-tight">Welcome back, {{ $page.props.auth?.roles?.some(r => ['ido_staff', 'college_officer'].includes(r)) ? $page.props.auth.user.name : 'Admin' }}</h1>
