    ...
    <main class="flex-1 overflow-y-auto scroll-smooth w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav aria-label="Breadcrumb" class="flex mb-6">
            <ol class="flex items-center space-x-2">
                ...
                <li>
                    <span class="text-slate-900 dark:text-white text-sm font-semibold">General Files</span>
                </li>
            </ol>
        </nav>
        <!-- Page Header & Actions -->
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-8">
            <div class="flex flex-col gap-2 max-w-2xl">
                <h1 class="text-3xl font-black text-slate-900 dark:text-white tracking-tight">General Files</h1>
                <p class="text-slate-600 dark:text-slate-400 text-base">
                    Files and documents accessible to all users and accreditors.
                </p>
            </div>
